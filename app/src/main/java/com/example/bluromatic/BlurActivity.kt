...
fun Context.getImageUri(): Uri {
    ...
    return Uri.Builder()
        ...
        .authority(resources.getResourcePackageName(R.drawable.snoopy))
        .appendPath(resources.getResourceTypeName(R.drawable.snoopy))
        .appendPath(resources.getResourceEntryName(R.drawable.snoopy))
        .build()
}
